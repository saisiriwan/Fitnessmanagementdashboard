...
const Button = ({
  ...
  const variants: any = {
    ...
    default:
      "bg-[#002140] text-white hover:bg-[#002140]/90 shadow-md hover:shadow-lg border border-transparent",
    // Outline: Light Gray border, Dark Gray text
    outline:
      "border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 hover:text-[#002140] shadow-sm",
    // Ghost: Subtle hover
    ghost: "hover:bg-slate-100 text-slate-600 hover:text-[#002140]",
    // Secondary/Accent: Vibrant Orange background
    secondary: "bg-[#FF6B35] text-white hover:bg-[#FF6B35]/90 shadow-sm",
...
const Input = ({ className, ...props }: any) => (
  <input
    className={cn(
      ...
      "flex h-11 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B35] focus-visible:border-transparent disabled:cursor-not-allowed disabled:opacity-50 transition-all shadow-sm text-black",
      className
    )}
    {...props}
  />
...
const Label = ({ className, children, ...props }: any) => (
  <label
    className={cn(
      "text-xs font-semibold text-[#002140] mb-2 block tracking-tight uppercase",
      className
    )}
    {...props}
  >
...
const Badge = ({ variant = "default", className, children }: any) => {
  const variants: any = {
    default:
      "border-transparent bg-[#002140] text-white shadow hover:bg-[#002140]/80",
    secondary:
  ...
  return (
    <div
      className={cn(
        "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[#002140] focus:ring-offset-2",
        variants[variant],
        className
      )}
    >
...
const SelectionRow = ({
  ...
  >
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <span
          className={cn(
            ...
            value ? "text-[#002140]" : "text-slate-400 italic"
          )}
        >
          {value || placeholder}
        </span>
    ...
    <Icons.ChevronRight className="w-5 h-5 text-slate-300 group-hover:text-[#FF6B35] group-hover:translate-x-0.5 transition-all" />
  </div>
);
  ...
  <div
    ...
    className={cn(
      ...
      isSelected
        ...
        : "border-transparent hover:bg-slate-50 text-slate-700 hover:text-[#002140]"
    )}
  >
      ...
      <div className="flex flex-col">
        <span
          className={cn(
            ...
            isSelected ? "text-[#002140]" : "text-[#002140]"
          )}
        >
          {label}
        </span>
    ...
    {isSelected && (
      <div className="bg-[#FF6B35] rounded-full p-0.5 mr-1 shadow-sm">
...
export default function ExerciseForm({
    ...
    if (field === "muscleGroups") {
      ...
      if (currentMuscles.includes(value)) {
        ...
        if (currentMuscles.length < 3) {
          ...
          return; // Silently ignore if already 3
        }
      }
  ...
  const handleSave = () => {
    if (!formData.name.trim()) {
      alert('กรุณากรอกชื่อท่าออกกำลังกาย');
      return;
    }
  ...
  const getSelectorTitle = (selector: string | null) => {
    switch (selector) {
      ...
      case "muscle":
        return "เลือกกลุ่มกล้ามเนื้อ (สูงสุด 3)";
      case "movement":
  ...
  return (
    <>
      <div
        className="fixed inset-0 z-50 bg-[#002140]/60 backdrop-blur-[4px] transition-all duration-300"
        aria-hidden="true"
        onClick={handleClose}
      />

      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 font-sans">
        <div className="w-full max-w-2xl bg-slate-50/50 rounded-3xl shadow-2xl flex flex-col max-h-[92vh] overflow-hidden animate-in zoom-in-95 duration-200 border border-white/20 ring-1 ring-[#002140]/5">
          {/* Header */}
          <div className="flex-none px-6 py-5 border-b border-slate-200/60 bg-white/95 backdrop-blur-xl z-10 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-bold text-[#002140] tracking-tight">
                  {initialData
                    ? "แก้ไขท่าออกกำลังกาย"
            ...
            <div className="px-6 py-8 space-y-8">
              ...
              <div className="space-y-3">
                <Label className="ml-1">
                  ชื่อท่าออกกำลังกาย <span className="text-[#FF6B35]">*</span>
                </Label>
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-1.5 focus-within:ring-2 focus-within:ring-[#FF6B35]/20 focus-within:border-[#FF6B35] transition-all group hover:border-slate-300 hover:shadow-md">
                  <div className="flex items-center px-3">
                    <div className="p-2 bg-slate-100 rounded-xl mr-3 text-slate-500 group-focus-within:bg-[#002140] group-focus-within:text-white transition-colors duration-300">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-1.5 focus-within:ring-2 focus-within:ring-[#002140] focus-within:border-transparent transition-all">
                  <div className="flex items-center border-b border-slate-50 px-4 py-2.5">
                    <Icons.Zap className="w-4 h-4 text-[#FF6B35] mr-3" />
                    <Input
          ...
          <div className="flex-none px-6 py-5 border-t border-slate-100 bg-white flex items-center justify-end gap-3 z-10 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.02)]">
            ...
            <Button
              variant="default"
              onClick={handleSave}
              className="h-12 px-8 rounded-xl bg-[#FF6B35] hover:bg-[#FF6B35]/90"
            >
          ...
          {activeSelector && (
            <div className="absolute inset-0 z-50 flex items-end sm:items-center justify-center bg-[#002140]/20 backdrop-blur-[2px]">
              <div
                className="w-full h-[85%] sm:h-auto sm:max-h-[600px] sm:max-w-md bg-white sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col animate-in slide-in-from-bottom-10 fade-in duration-300 ring-1 ring-[#002140]/5"
                onClick={(e) => e.stopPropagation()}
              >
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
                  <h3 className="text-base font-bold text-[#002140] tracking-tight">
